...
export default defineConfig({
  ...
  theme: {
    colors: {
      ...
      'primary': 'var(--app-color-primary, #19E65E)',
      'primary-dark': 'var(--app-color-primary-dark, #0EA842)',
      'background-light': 'var(--app-color-background-light, #F6F8F6)',
      'background-dark': 'var(--app-color-background-dark, #102216)',
      'surface-light': 'var(--app-color-surface-light, #FFFFFF)',
      'surface-dark': 'var(--app-color-surface-dark, #1C2B21)',
      'text-secondary': 'var(--app-color-text-secondary, #9DB8A6)',
      'success': 'var(--app-color-success, #10B981)',
      'warning': 'var(--app-color-warning, #FBBF24)',
      'danger': 'var(--app-color-danger, #EF4444)',
    },
    fontFamily: {
      display: 'Inter, Noto Sans SC, Noto Sans, sans-serif',
      sans: 'Inter, Noto Sans SC, Noto Sans, sans-serif',
